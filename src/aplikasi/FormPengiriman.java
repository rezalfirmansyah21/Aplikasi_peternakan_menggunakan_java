...
new Timer(1000, taskPerformer).start();
   ...
   public final void loadData() {
        ...
        try {
            ...
            String sql = "SELECT * FROM tbl_tmp_kirim";
    ...
    private void tampilpilih() {
     ...
     private void nofaktur() {
        try {
            ...
            String sql = "SELECT * FROM tbl_pengiriman ORDER by nofaktur desc";
            ResultSet r = s.executeQuery(sql);
            ...
            if (r.next()) {
                ...
                faktur.setText("P" + Nol + AN);
            } else {
                faktur.setText("P0001");
            }
    ...
    private void pilihbarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihbarangActionPerformed
        ...
        if (pilihbarang.getSelectedItem().equals("pilih barang")){
            ...
            try {
                ...
                String sql = "SELECT harga_beli FROM tbl_barang WHERE nama_barang ='" + pilihbarang.getSelectedItem() + "'";
                ResultSet r = s.executeQuery(sql);

                while (r.next()) {
                    hsatuan.setText(r.getString("harga_beli"));
                }
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if(faktur.getText().equals("") ||txtnama.getText().equals("") ||kdbarang.getText().equals("") || pilihbarang.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")|| ttotal.getText().equals("")){
            ...
            try {
                ...
                String sql = "INSERT INTO tbl_tmp_kirim VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        if ((jawaban = JOptionPane.showConfirmDialog(null,"Yakin batal?", "Konfirmasi", JOptionPane.YES_NO_OPTION)) == 0) {
            try{
                ...
                st.executeUpdate("delete from tbl_tmp_kirim where id_tmp = '"+id+ "'");
    ...
    private void btntotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntotalActionPerformed
        ...
        try {
            ...
            String sql = "SELECT SUM(`harga`) AS total FROM tbl_tmp_kirim";
            ResultSet r = s.executeQuery(sql);
            ...
            if(ab < 0){
                ...
                try {
                    ...
                    while (r.next()) {
                        ...
                        String sqla = "INSERT INTO tbl_pengiriman VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                        ...
                        p.setString(7, r.getString("harga_beli"));
                        p.setString(8, r.getString("jumlah_kirim"));
                    ...
                    try {
                        String sqla ="TRUNCATE `tbl_tmp_kirim";
    ...
    private void btncetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncetakActionPerformed
        // TODO add your handling code here
        String filename = path+"strukpengiriman.jrxml";
        JasperReport jasrep;
        JasperPrint japri;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql="SELECT * FROM tbl_supplier WHERE id like '"+ktp+"'";
