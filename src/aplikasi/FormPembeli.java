...
new Timer(1000, taskPerformer).start();
    ...
    private void kode() {
        try {
            ...
            String sql = "SELECT * FROM tbl_pembeli ORDER by id desc";
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        try {
            String sql ="delete from tbl_pembeli where id='"+txtid.getText()+"'";
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE tbl_pembeli SET nama =  '" + txtnama.getText() + "',no_telp='" + txttelp.getText() + "',alamat='" + txtalamat.getText() + "' WHERE  id ='" + idd + "'";
            PreparedStatement p = c.prepareStatement(sql);
            p.executeUpdate();
            p.close();
        } catch (SQLException e) {
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        ...
        try {
            ...
            String sql = "select * from tbl_pembeli where id like '%" + txtcari.getText() + "%' or nama like'%" + txtcari.getText() + "%' or no_telp like'" + txtcari.getText() + "%' or alamat like'%" + txtcari.getText() +"%'";
            ResultSet r = s.executeQuery(sql);
